          ...
          >
            {[
              ...
              <div key={i} className="flex items-center gap-3 text-zinc-300">
                <div className="h-6 w-6 rounded-full bg-[#E3B436]/20 flex items-center justify-center">
                  <div className="h-2 w-2 rounded-full bg-[#E3B436]" />
                </div>
                {feature}
              </div>
            ))}
          ...
          <div className="grid gap-4 md:gap-6">
            <form onSubmit={handleSignup} className="grid gap-3 md:gap-4">
              ...
              <Button 
                type="submit" 
                disabled={isSigningUp} 
                className="h-10 md:h-11 rounded-xl bg-gradient-to-r from-[#B94E30] to-[#8B3A24] hover:brightness-110 text-white font-bold shadow-lg shadow-[#B94E30]/20 transition-all hover:-translate-y-[1px] mt-2"
